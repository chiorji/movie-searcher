      ...
      <div className='collapse navbar-collapse' id='Navbar'>
        <ul className='navbar-nav ml-auto'>
          <li className='nav-item'>
            <a href='https://github.com/chigboguorji/movie-searcher.git' className='nav-link text-light'>Github</a>
          </li>
          <li className='nav-item'>
            <a href='https://www.themoviedb.org/' className='nav-link text-light'>About</a>
          </li>
        </ul>
      </div>
    </div>
